...
: ${AMENT_CURRENT_PREFIX:="/app/ros2_ws/install/edit_imgs_wrapper"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/edit_imgs_wrapper/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/edit_imgs_wrapper/environment/path.sh"
